...
public class NormalStrikeBox : StrikeBox
{
    ...
    public override void SetDirection(FacingDirection facingDirection)
    {
        ...
        Transform AttackOrb = transform.parent.Find("AttackOrb");
        ...
        switch (facingDirection)
        {
            case FacingDirection.Up:
                ...
                AttackOrb.localPosition = new Vector3(transform.localPosition.x, transform.localPosition.y + yOffset + 0.2f, transform.localPosition.z);
                break;
            case FacingDirection.Right:
                ...
                AttackOrb.localPosition = new Vector3(transform.localPosition.x + xOffset, transform.localPosition.y, transform.localPosition.z);
                break;
            ...
            case FacingDirection.Down:
                ...
                AttackOrb.localPosition = new Vector3(transform.localPosition.x, transform.localPosition.y - yOffset, transform.localPosition.z);
                break;
